...
--------   ---     ----------------------------------------------------------
04/24/14    dm     Added support to toggle the IV constraint check at runtime
03/25/14    dm     Added command structure to save aes and keyfile data
02/28/14    dm     Reverting back the backward compatibility support added for TZ_OUT_BUF_MAX macro

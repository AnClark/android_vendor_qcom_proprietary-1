...
private:
  ...
  uint64 m_nStartTime;
  //m_nStartTime gets updated to EPT value if sidx present. Hence also store m_nMPDStartTime
  uint64 m_nMPDStartTime;
  uint64 m_nDuration;

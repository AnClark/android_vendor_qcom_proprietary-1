  ...
  if(bOK)
  {
    ...
    if(m_currTSPkt.adaption_field.adaption_field_length)
    {
      ...
      else
      {
        ...
        MM_MSG_PRIO5(MM_FILE_OPS, MM_PRIO_DEBUG,
        ...
        {
          MM_MSG_PRIO(MM_FILE_OPS, MM_PRIO_DEBUG,
      ...
      if(pESDescData)
      {
                 ...
                 (m_nProgNumSelected) )
        {
          if(!m_nAudioPIDSelected)
            m_nStreamsSelected++;
          //! Use first identified audio stream as default audio stream
          if(!m_nAudioPIDSelected)
        ...
        {
            //! Check registration decriptor only if its available
            if(ES_info_length)
                 ...
                 AUDIO_CODEC_AC3) )
            {
              ...
              */
                      ...
                      (m_pAC3AudioDescriptor->ucBitRateCode <= 50))
              {
               ...
               AC3_BITRATE_CODE[m_pAC3AudioDescriptor->ucBitRateCode - 32]*1000;
              }
              else
              {

...
/*********************************************************************/
   ...
   {1.60000f, 1.000000f, 2.00000f},//{1.161000f, 1.000000f, 1.766000f},
   /* D50 Whitebalance - RGB */
   {1.414000f, 1.000000f, 1.391000f},
   /* A Whitebalance - RGB */
   {1.09000f, 1.000000f, 2.230000f},//{1.002000f, 1.000000f, 2.110000f},
   /* D65 Whitebalance - RGB */
   {1.766000f, 1.000000f, 1.085000f},//{1.518000f, 1.000000f, 1.105000f},
   /* Strobe Flash Whitebalance - RGB */
   {1.656000f, 1.000000f, 1.658000f},
   /* LED Flash Whitebalance - RGB */
   {1.79000f, 1.000000f, 1.83000f},//{1.656000f, 1.000000f, 1.658000f},
},
/* Auto Whitebalance */
{
   1, /* Software Type */
...
/*********************************************************************/
   ...
   /* AWB Reference Points w/HW */
   {
      /* D65 AWB Reference Point */
      {
         0.566000f,//0.644000f,   /* R/G ratio */
         0.942000f,//0.864000f,   /* B/G ratio */
      },
      /* Shade AWB Reference Point */
      {
         0.595000f,   /* R/G ratio */
      ...
      /* A AWB Reference Point */
      {
         0.923000f,//1.054000f,   /* R/G ratio */
         0.459000f,//0.489000f,   /* B/G ratio */
      },
      /* TL84 AWB Reference Point */
      {
         0.627000f,//0.865000f,   /* R/G ratio */
         0.528000f,//0.538000f,   /* B/G ratio */
      },
      /* CoolWhite AWB Reference Point */
      {
         0.644000f,//0.709000f,   /* R/G ratio */
         0.533000f,//0.476000f,   /* B/G ratio */
      },
      /* Horizon AWB Reference Point */
      {
         1.161000f,//1.223000f,   /* R/G ratio */
         0.395000f,//0.417000f,   /* B/G ratio */
      },
      /* D50 AWB Reference Point */
      {
         0.707000f,   /* R/G ratio */
   ...
   /* AWB Gain Adjust */
   {
      ...
      /* A */
      {
         0.970000f,//0.960000f, /* Red */
         1.0200000f,//1.020000f, /* Blue */
      },
      /* TL84 */
      {
         1.000000f, /* Red */
      ...
      /* Horizon */
      {
         0.93000f,//0.900000f, /* Red */
         1.06000f,//1.060000f, /* Blue */
      },
      /* D50 */
      {
         1.000000f, /* Red */
...
/******************************************************************************/
   ...
   /* Weight Vector */
   {
      ...
      {1, 10, 10, 1}, /* D75 */
      {0, 0, 1, 1}, /* A */
      {0, 0, 5, 1}, /* Warm Fluorescent */
      {0, 0, 3, 1}, /* Cool Fluorescent */
      {0, 0, 1, 1}, /* Horizon */
      {10, 10, 1, 1}, /* D50 */
      {0, 0, 1, 1}, /* Custom Fluorescent */
      {10, 10, 1, 1}, /* Noon */
      {1, 1, 1, 1}, /* Custom Daylight */
      {0, 0, 1, 1}, /* Custom A */
      {0, 0, 1, 1}, /* U30 */
      {8, 9, 8, 1}, /* Daylight Hybrid 1 */
      {1, 5, 10, 1}, /* Daylight Hybrid 2 */
      {0, 0, 2, 1}, /* A Line 1 */
      {0, 0, 1, 1}, /* A Line 2 */
      {0, 0, 5, 1}, /* F Line */
#endif

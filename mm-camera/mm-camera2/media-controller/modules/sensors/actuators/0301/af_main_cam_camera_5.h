...
============================================================================*/{
  {
    ...
    /* actuator_params_t */{
      ...
      4,
      /* init_settings */{
        {0xcc, MSM_ACTUATOR_BYTE_ADDR, 0x3b, MSM_ACTUATOR_BYTE_DATA, MSM_ACT_WRITE, 0},   /* 80Hz, slew rate 0x11 */
        {0xd4, MSM_ACTUATOR_BYTE_ADDR, 0x01, MSM_ACTUATOR_BYTE_DATA, MSM_ACT_WRITE, 0},   /* step mode, point A:0x001 */
        {0xdc, MSM_ACTUATOR_BYTE_ADDR, 0x02, MSM_ACTUATOR_BYTE_DATA, MSM_ACT_WRITE, 0},   /* step mode, point B:0x002 */

...
namespace TDLS_TEST
{
    ...
    /* Constructor */
    TDLSTestSuite::TDLSTestSuite(wifi_interface_handle handle, wifi_request_id request_id)
        :wifiHandle_(handle)
    {
    ...
    void TDLSTestSuite::setRequestId(int reqId)
    {
        id = reqId;
    }

    int TDLSTestSuite::getRequestId()
    {
        return id;
    }

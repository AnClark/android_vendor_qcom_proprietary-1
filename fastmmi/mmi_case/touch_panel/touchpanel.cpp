...
void add_btn(char *p) {
    ...
    case MENU:
        rect.y = height / 20;
        btn_menu = new mmi_button(rect, mmi_lang::query("menu"), NULL);
    ...
    case HOME:
        rect.y = height * 4 / 20;
        btn_home = new mmi_button(rect, mmi_lang::query("home"), NULL);
        btn_home->set_color(0, 125, 125, 255);
        g_module->add_btn(btn_home);
        break;
    case BACK:
        rect.y = height * 7 / 20;
        btn_back = new mmi_button(rect, mmi_lang::query("back"), NULL);

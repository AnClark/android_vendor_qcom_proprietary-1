...
void add_btn(char *p) {
    ...
    case VOLUME_UP:
        rect.y = height / 20;
        btn_volume_up = new mmi_button(rect, mmi_lang::query("volumeup"), NULL);
    ...
    case VOLUME_DOWN:
        rect.y = height * 4 / 20;
        btn_volume_down = new mmi_button(rect, mmi_lang::query("volumedown"), NULL);
        btn_volume_down->set_color(0, 125, 125, 255);
        g_module->add_btn(btn_volume_down);
        break;
    case CAMERA_SNAPSHOT:
        rect.y = height * 7 / 20;
        btn_cam = new mmi_button(rect, mmi_lang::query("camsnapshot"), NULL);

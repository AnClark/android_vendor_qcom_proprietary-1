...
#define RECT_WIDTH (gr_fb_width() / 2 - 20)
#define RECT_HEIGHT (gr_fb_height() / 5 - 60)
#define RECT_Y (gr_fb_height() * 4 / 5)
#define RECT_PASS_X 10
#define RECT_FAIL_X (gr_fb_width() / 2 + 10)

#define CENTER_POINT_PASS_X (RECT_PASS_X+RECT_WIDTH/2)
#define CENTER_POINT_FAIL_X (RECT_FAIL_X+RECT_WIDTH/2)
...
class mmi_module {
  ...
  public:
    ...
    int mod_sem_timewait(const struct timespec *ts);

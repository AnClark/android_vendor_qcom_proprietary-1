...
extern int ulp_msg_forward_quipc_venue_status      (int                quipc_error_code,
                                                    int                quipc_venue_info_length,
...
extern int ulp_quipc_send_pvd_query  (const UlpLocation* coarse_pos_ptr);

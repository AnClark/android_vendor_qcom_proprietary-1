                         ...
                         int mac_array[], int rssi_array [], int channel_array[])
{
  ...
  {
    llog.v(TAG, "location report callback 1: source validity: " + is_source_valid +
           ", latitude validity: " + is_latitude_valid + ", longitude validity: " +
           is_longitude_valid + ", unc validity: " + is_hor_unc_valid +
           ", timestamp validity: " + is_timestamp_valid);

    llog.v(TAG, "location report callback 2: source " + source_bitmask +
           ", (" + latitude + ", " + longitude + "), unc " + hor_unc +
           ", timestamp " + timestamp);

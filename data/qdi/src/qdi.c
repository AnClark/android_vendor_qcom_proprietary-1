...
)
{
  ...
  {
    DS_INET4_NTOP(med,"Interface",     (unsigned char*)(SASTORAGE_DATA(addr_info->iface_addr_s.addr)));
    DS_INET4_NTOP(med,"Gateway",       (unsigned char*)(SASTORAGE_DATA(addr_info->gtwy_addr_s.addr)));
    DS_INET4_NTOP(med,"DNS Primary",   (unsigned char*)(SASTORAGE_DATA(addr_info->dnsp_addr_s.addr)));
    DS_INET4_NTOP(med,"DNS Secondary", (unsigned char*)(SASTORAGE_DATA(addr_info->dnss_addr_s.addr)));
  }
  else
  {
    DS_INET6_NTOP(med,"Interface",     (unsigned char*)(SASTORAGE_DATA(addr_info->iface_addr_s.addr)));
    DS_INET6_NTOP(med,"Gateway",       (unsigned char*)(SASTORAGE_DATA(addr_info->gtwy_addr_s.addr)));
    DS_INET6_NTOP(med,"DNS Primary",   (unsigned char*)(SASTORAGE_DATA(addr_info->dnsp_addr_s.addr)));
    DS_INET6_NTOP(med,"DNS Secondary", (unsigned char*)(SASTORAGE_DATA(addr_info->dnss_addr_s.addr)));
  }
  ret = QDI_SUCCESS;

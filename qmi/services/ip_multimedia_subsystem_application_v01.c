...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/imsa/main/latest/src/ip_multimedia_subsystem_application_v01.c#30 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t imsa_get_registration_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_registration_status_resp_msg_v01, registration_error_string) - QMI_IDL_OFFSET8(imsa_get_registration_status_resp_msg_v01, registration_error_string_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
...
static const uint8_t imsa_registration_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_registration_status_ind_msg_v01, registration_error_string) - QMI_IDL_OFFSET8(imsa_registration_status_ind_msg_v01, registration_error_string_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
...
static const qmi_idl_service_message_table_entry imsa_service_response_messages_v01[] = {
  ...
  {QMI_IMSA_GET_REGISTRATION_STATUS_RSP_V01, QMI_IDL_TYPE16(0, 1), 281},
...
static const qmi_idl_service_message_table_entry imsa_service_indication_messages_v01[] = {
  {QMI_IMSA_REGISTRATION_STATUS_IND_V01, QMI_IDL_TYPE16(0, 6), 274},

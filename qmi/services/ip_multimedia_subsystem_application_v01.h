...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/imsa/main/latest/api/ip_multimedia_subsystem_application_v01.h#30 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.3 
   It was generated on: Thu Feb  5 2015 (Spin 1)
...
#define IMSA_V01_IDL_MINOR_VERS 0x12
...
typedef enum {
  ...
  IMSA_NETWORK_PROV_OUT_OF_SYNC_V01 = 0, /**<  Network is out of sync 
       Indication sent when IMS UE detects network provisioning status through 
       SIP messages. When the network is out of sync with UE, DM re-sync 
       may be triggered by OEM based on this indication.
  \n  */
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Request Message; Get the RTP Statistics */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Response Message; Get the RTP Statistics */
typedef struct {
...
typedef struct {
 ...
 Values:\n
      - IMSA_NETWORK_PROV_OUT_OF_SYNC (0) --  Network is out of sync 
       Indication sent when IMS UE detects network provisioning status through 
       SIP messages. When the network is out of sync with UE, DM re-sync 
       may be triggered by OEM based on this indication.
  \n 
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indication sent when Get RTP Statistics request is queried */
typedef struct {

  /* Optional */
  /*  RTP Statistics Parameter - total number of RTP packets expected on RX */
  ...
  /**<   total number of packets expected on RX 
       from the beginning of the call till the time of request  ,
       measured across all the opened sessions.\n
    */

  /* Optional */
  /*  RTP Statistics parameter - total number of RTP packets lost on RX */

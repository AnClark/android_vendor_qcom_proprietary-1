...
static const uint8_t dfs_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, report_reverse_ip_transport_filters_update) - QMI_IDL_OFFSET8(dfs_indication_register_req_msg_v01, report_reverse_ip_transport_filters_update_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry dfs_service_command_messages_v01[] = {
  {QMI_DFS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 24), 12},

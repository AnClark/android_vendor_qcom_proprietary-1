    ...
    :SAMSensor(handle)
{
    if(getAttribOK() == true) {
        ...
        setMaxRange(SNS_SAM_CMC_MS_E_MAX_ENUM_VAL_V01); /* range of enum values */
        setResolution(1);
...
void CoarseMotionClassifier::processResp(sensor1_msg_header_s *msg_hdr, void *msg_ptr)
{
    ...
    if(true != error ) {
        ...
        case SNS_SAM_CMC_ENABLE_RESP_V01:
            ...
            instance_id = ((sns_sam_cmc_enable_resp_msg_v01 *)msg_ptr)->instance_id;
            break;
...
void CoarseMotionClassifier::processInd(sensor1_msg_header_s *msg_hdr, void *msg_ptr)
{
    ...
    switch(msg_hdr->msg_id) {
        ...
        case SNS_SAM_CMC_ERROR_IND_V01:
            HAL_LOG_ERROR("%s: SNS_SAM_CMC_ERROR_IND_V01", __FUNCTION__);
            error = true;
            break;
        default:

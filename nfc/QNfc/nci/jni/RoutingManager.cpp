...
void RoutingManager::updateRouting()
{
    ...
    if (mIsRoutingToHost)
    {
        if (mIsRoutingToSE)
        {
            if ((mActiveSeTechMask & NFA_TECHNOLOGY_MASK_A) == 0)
    ...
    else
    {
        ...
        {
            techMaskForDH  = NFA_TECHNOLOGY_MASK_A|NFA_TECHNOLOGY_MASK_B;
            techMaskForSE  = 0;
            protoMaskForDH = NFA_PROTOCOL_MASK_NFC_DEP;
            protoMaskForSE = 0;
        }
...
bool RoutingManager::addAidRouting(const UINT8* aid, UINT8 aidLen, int route)
{
    ...
    if (route == NFC_DH_ID)
        nfaStat = NFA_EeAddAidRouting(route, aidLen, (UINT8*) aid, NFA_EE_PWR_STATE_ON);
    else
        nfaStat = NFA_EeAddAidRouting(route, aidLen, (UINT8*) aid, (NFA_EE_PWR_STATE_ON | NFA_EE_PWR_STATE_SWITCH_OFF));
...
void RoutingManager::initializeT3TagEmulation()
{
    ...
    if (test_app1_nfcid2_size = GetStrValue("TEST_APP1_NFCID2", (char*)test_app1_nfcid2, sizeof(test_app1_nfcid2)))
    {
    ...
    if (test_app1_sysCode_size = GetStrValue("TEST_APP1_SYSTEM_CODE", (char*)test_app1_sysCode, sizeof(test_app1_sysCode)))
    {
    ...
    if (test_app2_nfcid2_size = GetStrValue("TEST_APP2_NFCID2", (char*)test_app2_nfcid2, sizeof(test_app2_nfcid2)))
    {
    ...
    if (test_app2_sysCode_size = GetStrValue("TEST_APP2_SYSTEM_CODE", (char*)test_app2_sysCode, sizeof(test_app2_sysCode)))
    {
    ...
    //Test App3
    if (test_app3_nfcid2_size = GetStrValue("TEST_APP3_NFCID2", (char*)test_app3_nfcid2, sizeof(test_app3_nfcid2)))
    {
    ...
    if (test_app3_sysCode_size = GetStrValue("TEST_APP3_SYSTEM_CODE", (char*)test_app3_sysCode, sizeof(test_app3_sysCode)))
    {

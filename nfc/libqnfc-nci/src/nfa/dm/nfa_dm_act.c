...
**
*******************************************************************************/
void nfa_dm_dta_set_pattern(tNFA_DM_MSG *p_data)
{
...
void nfa_dm_notify_activation_status (tNFA_STATUS status, tNFA_TAG_PARAMS *p_params)
{
    ...
    {
        /*  QNCI_FEATURE_UI_SCREEN_ERR_HANDLE */
        if ((nfa_dm_cb.disc_cb.activated_rf_interface != NFC_INTERFACE_EE_DIRECT_RF) && (nfa_dm_cb.req_screen_off_lock != 0xFF))
        {
            tNFC_RESPONSE   evt_data;
            nfa_dm_cb.req_screen_off_lock = 0xFF;
            NFA_TRACE_DEBUG0 ("nfa_dm_notify_activation_status:pending screen cmd");

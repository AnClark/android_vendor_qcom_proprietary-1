...
public class WbcService extends IWbcService.Stub implements WipowerBatteryControl.WbcEventListener {
    ...
    private final class ServiceHandler extends Handler {
        ...
        boolean isBluetoothOn() {
            ...
            try {
                final IBluetoothManager btMgr = IBluetoothManager.Stub.asInterface(
                    ServiceManager.checkService(BluetoothAdapter.BLUETOOTH_MANAGER_SERVICE));
                btState = btMgr.isEnabled();
                Log.d(TAG, "isBluetoothOn called, BT Mgr State: " + btMgr.isEnabled());
            } catch (RemoteException e) {
                Log.e(TAG, "couldn't get Bluetooth Mgr Svc");
            }

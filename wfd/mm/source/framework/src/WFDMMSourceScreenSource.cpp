...
#ifdef MAX_BUFFER_ASSUME
#undef MAX_BUFFER_ASSUME
#endif
		    ...
		    m_eScrnSrcState = WFDMM_SCREENSOURCE_STATE_PLAY;
                    ...
                    else
                    {
                     ...
                     //   memset(ucPESPvtData, 0, PES_PVT_DATA_LEN );
                        ...
                        {
#if 1 /*H/w lib*/
                              signed long ulStatus = m_pHdcpHandle->WFD_HdcpDataEncrypt(STREAM_VIDEO ,
...
int ScreenSource::Subscribe_Events(int fd, bool subscribe)
{
  ...
  for (unsigned int index = 0; index < ARRAY_SZ(V4L2_events); ++index)
  {

...
#include "MMDebugMsg.h"
      ...
      OMX_S32 nDataSize)
  {
    ...
    if (result == OMX_ErrorNone)
    {
      ...
      {
        MM_MSG_PRIO(MM_GENERAL,MM_PRIO_HIGH,"failed to pop queue");
      ...
      OMX_S32 nDataSize)
  {
    ...
    {
      MM_MSG_PRIO(MM_GENERAL,MM_PRIO_HIGH,"failed to push onto queue");
      result = OMX_ErrorUndefined;
    }
      ...
      OMX_S32 nDataSize)
  {
    ...
    {
      MM_MSG_PRIO(MM_GENERAL,MM_PRIO_HIGH,"failed to peek into queue");
      result = OMX_ErrorUndefined;
    }

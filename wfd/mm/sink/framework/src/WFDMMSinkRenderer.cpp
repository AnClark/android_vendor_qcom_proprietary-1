...
bool WFDMMSinkRenderer::RenderVideo(frameInfoType *pFrameInfo)
{
    ...
    BufferDim_t bufferDim = {static_cast<OMX_S32>(pPictInfo->rect.nWidth), static_cast<OMX_S32>(pPictInfo->rect.nHeight)};
                                    ...
                                    uint32  bufferId)
{
    ...
    WFDMMLOGM1("Searching for Buffer Id = %lu", bufferId);
...
)
{
    ...
    if((int)(*((int*)pCmpValue)) == (int)pGraphicBuffer->handle)
    {
        ...
        WFDMMLOGM1("Buffer Found %lu", (uint32)pCmpValue);
